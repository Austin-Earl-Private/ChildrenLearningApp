...
public class Animal extends A_Animal {
    String animalName = "";
    ...
    public Animal(String animalName, Context context, int soundRef, boolean correct , int imageRef) {
...
//        players.get(rand.nextInt(players.size())).start();
    ...
    @Override
    public int getAnimalSoundRef() {
        return soundRef;
    }

    @Override
    public int getAnimalImageRef() {
        return imgRef;
    }
}
